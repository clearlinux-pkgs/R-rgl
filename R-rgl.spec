...
Version  : 0.100.50
Release  : 34
URL      : https://cran.r-project.org/src/contrib/rgl_0.100.50.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rgl_0.100.50.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582304043
