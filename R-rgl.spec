...
Version  : 0.104.16
Release  : 42
URL      : https://cran.r-project.org/src/contrib/rgl_0.104.16.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rgl_0.104.16.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610303524
